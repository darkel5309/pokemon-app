...
export class Detalles {
    ...
    constructor(id: number, name: string, weight: string, height: string, image: string, types: Tipo[], moves: Movimiento[], abilities: Habilidad[], species: Especie, cries: string) {
        this._name = name;
        this._id = id;
        this._weight = weight;
        this._height = height;
